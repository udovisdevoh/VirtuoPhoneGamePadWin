 ...
 */
public class Drone {
	private boolean isLazyHarmonic = false;
	
	private boolean isMinimizePitchShift = false;
	...
	public void onPlayNoteUpdate(SoundPool soundPool, GuitarPreset guitarPreset, Point coordinates) {
		...
		boolean isDroneNeedToChangeForChord;
	...
	public boolean isLazyHarmonic() {
		return isLazyHarmonic;
	}
	
	public boolean isMinimizePitchShift() {
	...
	public void isLazyHarmonic(boolean isLazyHarmonic) {
		this.isLazyHarmonic = isLazyHarmonic;
	}

	public void isMinimizePitchShift(boolean isMinimizePitchShift) {
